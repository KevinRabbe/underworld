...
func _run() -> void:
	...
	if failures.is_empty():
		...
		print("  gameplay codecs / integrated detached save schema / typed wire / atomic slot lifecycle / source-level legacy retirement / restored loot allocator through real Game Continue activation passed")
		quit(0)
		return
