...
static func build() -> Resource:
	...
	var modules: Array[Resource] = [
		...
		_module("trousers", &"leg_outfit", [
			_part("thigh_l", "rig_role.thigh.left", _box(Vector3i(-1,-8,-1), Vector3i(1,0,1), CLOTH), Vector3i(0,-1,0)),
			_part("calf_l", "rig_role.calf.left", _box(Vector3i(-1,-7,-1), Vector3i(1,0,1), CLOTH), Vector3i(0,-1,0)),
			_part("thigh_r", "rig_role.thigh.right", _box(Vector3i(-1,-8,-1), Vector3i(1,0,1), CLOTH), Vector3i(0,-1,0)),
			_part("calf_r", "rig_role.calf.right", _box(Vector3i(-1,-7,-1), Vector3i(1,0,1), CLOTH), Vector3i(0,-1,0)),
		]),
