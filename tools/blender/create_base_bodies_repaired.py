...
def build_male_topology():
    ...
    _ring_surface(verts,faces,[(0.40,0,.105,.235,.155),(0.48,0,.105,.245,.160),(0.56,0,.105,.225,.150),(0.66,0,.100,.220,.145),(0.76,0,.095,.180,.125),(0.84,0,.090,.205,.138),(0.96,0,.085,.220,.145),(1.08,0,.08,.190,.110),(1.20,0,.08,.195,.112),(1.32,0,.08,.205,.120,.016,.010),(1.44,0,.08,.270,.145,.040,.024),(1.54,0,.08,.285,.140,.032,.020),(1.61,0,.08,.205,.105,.014,.008),(1.68,0,.08,.120,.090),(1.73,0,.08,.085,.075)],24,True,True)
    ...
    for vertex in obj.data.vertices:
        ...
        if y < 0.02:
            ...
            vertex.co.y += 0.034 * lat + 0.018 * trap - 0.012 * spine
        elif y > 0.10 and 0.88 <= z < 1.20:
            lower_back = math.exp(-((x / 0.075) ** 2) - (((z - 1.03) / 0.170) ** 2))
            vertex.co.y -= 0.012 * lower_back
