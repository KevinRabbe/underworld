...
def build_male_topology():
    ...
    _ring_surface(verts,faces,[(0.48,0,.105,.205,.135),(0.56,0,.105,.225,.150),(0.66,0,.100,.220,.145),(0.76,0,.095,.180,.125),(0.84,0,.090,.205,.138),(0.96,0,.085,.220,.145),(1.08,0,.08,.175,.105),(1.20,0,.08,.180,.108),(1.32,0,.08,.205,.120,.016,.004),(1.44,0,.08,.270,.145,.040,.012),(1.54,0,.08,.285,.140,.032,.010),(1.61,0,.08,.205,.105,.014,.006),(1.68,0,.08,.120,.090),(1.73,0,.08,.085,.075)],16,True,True)
    _ring_surface(verts,faces,[(1.70,0,.08,.085,.068,.020,.002),(1.77,0,.08,.105,.080,.045,.004),(1.88,0,.08,.102,.086,.028,.004),(1.96,0,.08,.080,.070,.006,.002),(2.00,0,.08,.030,.030)],14,True,True)
    # Arms: shoulder, elbow and wrist landmarks are explicit rings, not tubes.
    for s in (-1,1):
        _segment_surface(verts,faces,[(s*.22,.08,1.54),(s*.30,.08,1.50),(s*.47,.08,1.39)],[.130,.108,.068],10,True,True)
